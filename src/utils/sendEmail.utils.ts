...
export const resetPasswordTemplate = (
  ...
  const email = {
    body: {
      name: userName,
      intro:
        "Você recebeu este email porque uma solicitação de redefinição de senha foi feita para sua conta.",
      action: {
        instructions: "Clique no botão abaixo para redefinir sua senha:",
        button: {
          color: "#22BC66",
          text: "Redefinir minha senha",
          link: `https://motors-shop-git-developer-motors-shop-deploy.vercel.app/reset-password/${resetToken}`,
